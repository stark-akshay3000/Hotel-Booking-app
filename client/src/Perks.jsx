...
<input checked={selected.includes('Private entrance')} name="Private entrance" onChange={handleCbClick}  type="checkbox" />
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
...
<input checked={selected.includes('Pool')} name="Pool" onChange={handleCbClick} type="checkbox" />
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
